...
import { resolveViteManifest, ViteManifest } from './resolve-vite-manifest.js'
import commandLineArgs from 'command-line-args'
import commandLineUsage from 'command-line-usage'
import { viteFlatManifestTags } from './vite-manifest-tags.js'


type FlatViteManifestArgs = {
    src?: string | null,
    output?: string | null,
    tags?: string | null,
    help?: boolean,
...
async function flatViteManifest() {
    ...
    try {
        const args = commandLineArgs(commandOptions) as FlatViteManifestArgs
