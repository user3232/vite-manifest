 ...
 */
export function viteFlatManifestTags(flatManifest) {
    let string = '';
 ...
 */
export function viteFlatManifestEntryToTags(flatManifestEntry, indent) {
    indent ??= 0;
...
//# sourceMappingURL=vite-manifest-tags.js.map